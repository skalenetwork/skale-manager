...
describe("nodeRotation", () => {
    ...
    describe("Tests without memory", () => {
        ...
        fastBeforeEach(async () => undefined);
        ...
        it("64 node rotations on 17 nodes", async () => {
            ...
            for (let schainNumber = 0; schainNumber < numberOfSchains; schainNumber++) {
                const result = await (await schains.addSchainByFoundation(0, SchainType.SMALL, 0, "schain-" + schainNumber, owner.address, ethers.constants.AddressZero, "0x")).wait();
