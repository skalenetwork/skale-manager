 ...
 */
contract SchainsInternalMigrator is Permissions, IPruningSchainsInternal {
        ...
        //onlyOwner
    {
        ...
        for (uint256 i = 0; i < nSchains; ++i) {
            schains[hashes[i]].owner = newOwner;
            schainIndexes[newOwner].push(hashes[i]);
