...
contract SkaleDKG is Permissions {
    ...
    uint constant private P = 21888242871839275222246405745257275088696311157297823662689037894645226208583;

    uint constant private G2A = 10857046999023057135944570762232829481370756359578518086990519993285655852781;
    uint constant private G2B = 11559732032986387107991004021392285783925812861821192530917403151452391805634;
    uint constant private G2C = 8495653923123431417604973247489272438418190587263600148770280649306958101930;
    uint constant private G2D = 4082367875863433681332203403145435568316851327593401208105741076214120093531;

    uint constant private TWISTBX = 19485874751759354771024239261021720505790618469301721065564631296452457478373;
    uint constant private TWISTBY = 266929791119991161246907387137283842545076965332900288569378510910307636690;

    uint constant private G1A = 1;
    uint constant private G1B = 2;

    mapping(bytes32 => Channel) public channels;
    mapping(bytes32 => mapping(uint => BroadcastedData)) private data;
