...
:onlyNodeOrNodeManager: pass:normal[xref:#Nodes-onlyNodeOrNodeManager-uint256-[`++onlyNodeOrNodeManager++`]]
:onlyCompliance: pass:normal[xref:#Nodes-onlyCompliance--[`++onlyCompliance++`]]
:nonZeroIP: pass:normal[xref:#Nodes-nonZeroIP-bytes4-[`++nonZeroIP++`]]
:COMPLIANCE_ROLE: pass:normal[xref:#Nodes-COMPLIANCE_ROLE-bytes32[`++COMPLIANCE_ROLE++`]]
:NODE_MANAGER_ROLE: pass:normal[xref:#Nodes-NODE_MANAGER_ROLE-bytes32[`++NODE_MANAGER_ROLE++`]]
...
:domainNames: pass:normal[xref:#Nodes-domainNames-mapping-uint256----string-[`++domainNames++`]]
:incompliant: pass:normal[xref:#Nodes-incompliant-mapping-uint256----bool-[`++incompliant++`]]
...
:setNodeIncompliant: pass:normal[xref:#Nodes-setNodeIncompliant-uint256-[`++setNodeIncompliant++`]]
:setNodeCompliant: pass:normal[xref:#Nodes-setNodeCompliant-uint256-[`++setNodeCompliant++`]]
:setDomainName: pass:normal[xref:#Nodes-setDomainName-uint256-string-[`++setDomainName++`]]
:makeNodeVisible: pass:normal[xref:#Nodes-makeNodeVisible-uint256-[`++makeNodeVisible++`]]
:makeNodeInvisible: pass:normal[xref:#Nodes-makeNodeInvisible-uint256-[`++makeNodeInvisible++`]]
:changeIP: pass:normal[xref:#Nodes-changeIP-uint256-bytes4-bytes4-[`++changeIP++`]]
:getRandomNodeWithFreeSpace: pass:normal[xref:#Nodes-getRandomNodeWithFreeSpace-uint8-struct-Random-RandomGenerator-[`++getRandomNodeWithFreeSpace++`]]
...
:getNodeDomainName: pass:normal[xref:#Nodes-getNodeDomainName-uint256-[`++getNodeDomainName++`]]
...
:getNodeAddress: pass:normal[xref:#Nodes-getNodeAddress-uint256-[`++getNodeAddress++`]]
...
:_removeNodeFromSpaceToNodes: pass:normal[xref:#Nodes-_removeNodeFromSpaceToNodes-uint256-uint8-[`++_removeNodeFromSpaceToNodes++`]]
:NodeCreated: pass:normal[xref:#Nodes-NodeCreated-uint256-address-string-bytes4-bytes4-uint16-uint16-string-uint256-uint256-[`++NodeCreated++`]]
...
:Node: pass:normal[xref:#Nodes-Node[`++Node++`]]
:CreatedNodes: pass:normal[xref:#Nodes-CreatedNodes[`++CreatedNodes++`]]
:SpaceManaging: pass:normal[xref:#Nodes-SpaceManaging[`++SpaceManaging++`]]
:NodeCreationParams: pass:normal[xref:#Nodes-NodeCreationParams[`++NodeCreationParams++`]]
:NodeStatus: pass:normal[xref:#Nodes-NodeStatus[`++NodeStatus++`]]
...
* {xref-Nodes-onlyNodeOrNodeManager-uint256-}[`++onlyNodeOrNodeManager(nodeIndex)++`]
* {xref-Nodes-onlyCompliance--}[`++onlyCompliance()++`]
* {xref-Nodes-nonZeroIP-bytes4-}[`++nonZeroIP(ip)++`]
--
...
* {xref-Nodes-setNodeIncompliant-uint256-}[`++setNodeIncompliant(nodeIndex)++`]
* {xref-Nodes-setNodeCompliant-uint256-}[`++setNodeCompliant(nodeIndex)++`]
* {xref-Nodes-setDomainName-uint256-string-}[`++setDomainName(nodeIndex, domainName)++`]
* {xref-Nodes-makeNodeVisible-uint256-}[`++makeNodeVisible(nodeIndex)++`]
* {xref-Nodes-makeNodeInvisible-uint256-}[`++makeNodeInvisible(nodeIndex)++`]
* {xref-Nodes-changeIP-uint256-bytes4-bytes4-}[`++changeIP(nodeIndex, newIP, newPublicIP)++`]
* {xref-Nodes-getRandomNodeWithFreeSpace-uint8-struct-Random-RandomGenerator-}[`++getRandomNodeWithFreeSpace(freeSpace, randomGenerator)++`]
* {xref-Nodes-isTimeForReward-uint256-}[`++isTimeForReward(nodeIndex)++`]
* {xref-Nodes-getNodeIP-uint256-}[`++getNodeIP(nodeIndex)++`]
* {xref-Nodes-getNodeDomainName-uint256-}[`++getNodeDomainName(nodeIndex)++`]
* {xref-Nodes-getNodePort-uint256-}[`++getNodePort(nodeIndex)++`]
* {xref-Nodes-getNodePublicKey-uint256-}[`++getNodePublicKey(nodeIndex)++`]
* {xref-Nodes-getNodeAddress-uint256-}[`++getNodeAddress(nodeIndex)++`]
...
* {xref-Nodes-_removeNodeFromSpaceToNodes-uint256-uint8-}[`++_removeNodeFromSpaceToNodes(nodeIndex, space)++`]
--

[.contract-index]
.Events
--
* {xref-Nodes-NodeCreated-uint256-address-string-bytes4-bytes4-uint16-uint16-string-uint256-uint256-}[`++NodeCreated(nodeIndex, owner, name, ip, publicIP, port, nonce, domainName, time, gasSpend)++`]
...
[.contract-item]
[[Nodes-onlyNodeOrNodeManager-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=Nodes-onlyNodeOrNodeManager-uint256->onlyNodeOrNodeManager</a>+++ `++onlyNodeOrNodeManager(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#modifier#



[.contract-item]
[[Nodes-onlyCompliance--]]
== +++<a class="heading-anchor" area-hidden="true" name=Nodes-onlyCompliance-->onlyCompliance</a>+++ `++onlyCompliance()++` [.item-kind]#modifier#



[.contract-item]
[[Nodes-nonZeroIP-bytes4-]]
== +++<a class="heading-anchor" area-hidden="true" name=Nodes-nonZeroIP-bytes4->nonZeroIP</a>+++ `++nonZeroIP(++[.var-type]#++bytes4++#++ ++[.var-name]#++ip++#++)++` [.item-kind]#modifier#
...
[.contract-item]
[[Nodes-setNodeIncompliant-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=Nodes-setNodeIncompliant-uint256->setNodeIncompliant</a>+++ `++setNodeIncompliant(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#

Marks the node as incompliant


[.contract-item]
[[Nodes-setNodeCompliant-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=Nodes-setNodeCompliant-uint256->setNodeCompliant</a>+++ `++setNodeCompliant(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#

Marks the node as compliant


[.contract-item]
[[Nodes-setDomainName-uint256-string-]]
== +++<a class="heading-anchor" area-hidden="true" name=Nodes-setDomainName-uint256-string->setDomainName</a>+++ `++setDomainName(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++string++#++ ++[.var-name]#++domainName++#++)++` [.item-kind]#external#



[.contract-item]
[[Nodes-makeNodeVisible-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=Nodes-makeNodeVisible-uint256->makeNodeVisible</a>+++ `++makeNodeVisible(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#



[.contract-item]
[[Nodes-makeNodeInvisible-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=Nodes-makeNodeInvisible-uint256->makeNodeInvisible</a>+++ `++makeNodeInvisible(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#



[.contract-item]
[[Nodes-changeIP-uint256-bytes4-bytes4-]]
== +++<a class="heading-anchor" area-hidden="true" name=Nodes-changeIP-uint256-bytes4-bytes4->changeIP</a>+++ `++changeIP(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++bytes4++#++ ++[.var-name]#++newIP++#++, ++[.var-type]#++bytes4++#++ ++[.var-name]#++newPublicIP++#++)++` [.item-kind]#external#



[.contract-item]
[[Nodes-getRandomNodeWithFreeSpace-uint8-struct-Random-RandomGenerator-]]
== +++<a class="heading-anchor" area-hidden="true" name=Nodes-getRandomNodeWithFreeSpace-uint8-struct-Random-RandomGenerator->getRandomNodeWithFreeSpace</a>+++ `++getRandomNodeWithFreeSpace(++[.var-type]#++uint8++#++ ++[.var-name]#++freeSpace++#++, ++[.var-type]#++struct Random.RandomGenerator++#++ ++[.var-name]#++randomGenerator++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#
...
[.contract-item]
[[Nodes-getNodeDomainName-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=Nodes-getNodeDomainName-uint256->getNodeDomainName</a>+++ `++getNodeDomainName(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++string++#++++` [.item-kind]#external#
...
[.contract-item]
[[Nodes-getNodeAddress-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=Nodes-getNodeAddress-uint256->getNodeAddress</a>+++ `++getNodeAddress(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++address++#++++` [.item-kind]#external#
...
== +++<a class="heading-anchor" area-hidden="true" name=Nodes-countNodesWithFreeSpace-uint8->countNodesWithFreeSpace</a>+++ `++countNodesWithFreeSpace(++[.var-type]#++uint8++#++ ++[.var-name]#++freeSpace++#++) → ++[.var-type]#++uint256++#++ ++[.var-name]#++count++#++++` [.item-kind]#external#
...
[.contract-item]
[[Nodes-_removeNodeFromSpaceToNodes-uint256-uint8-]]
== +++<a class="heading-anchor" area-hidden="true" name=Nodes-_removeNodeFromSpaceToNodes-uint256-uint8->_removeNodeFromSpaceToNodes</a>+++ `++_removeNodeFromSpaceToNodes(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++uint8++#++ ++[.var-name]#++space++#++)++` [.item-kind]#internal#




[.contract-item]
[[Nodes-NodeCreated-uint256-address-string-bytes4-bytes4-uint16-uint16-string-uint256-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=Nodes-NodeCreated-uint256-address-string-bytes4-bytes4-uint16-uint16-string-uint256-uint256->NodeCreated</a>+++ `++NodeCreated(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++address++#++ ++[.var-name]#++owner++#++, ++[.var-type]#++string++#++ ++[.var-name]#++name++#++, ++[.var-type]#++bytes4++#++ ++[.var-name]#++ip++#++, ++[.var-type]#++bytes4++#++ ++[.var-name]#++publicIP++#++, ++[.var-type]#++uint16++#++ ++[.var-name]#++port++#++, ++[.var-type]#++uint16++#++ ++[.var-name]#++nonce++#++, ++[.var-type]#++string++#++ ++[.var-name]#++domainName++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++time++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++gasSpend++#++)++` [.item-kind]#event#
