...
:onlySchainTypeManager: pass:normal[xref:#SchainsInternal-onlySchainTypeManager--[`++onlySchainTypeManager++`]]
:onlyDebugger: pass:normal[xref:#SchainsInternal-onlyDebugger--[`++onlyDebugger++`]]
...
:usedSchainNames: pass:normal[xref:#SchainsInternal-usedSchainNames-mapping-bytes32----bool-[`++usedSchainNames++`]]
:schainTypes: pass:normal[xref:#SchainsInternal-schainTypes-mapping-uint256----struct-SchainsInternal-SchainType-[`++schainTypes++`]]
:numberOfSchainTypes: pass:normal[xref:#SchainsInternal-numberOfSchainTypes-uint256[`++numberOfSchainTypes++`]]
:placeOfSchainOnNode: pass:normal[xref:#SchainsInternal-placeOfSchainOnNode-mapping-bytes32----mapping-uint256----uint256--[`++placeOfSchainOnNode++`]]
:SCHAIN_TYPE_MANAGER_ROLE: pass:normal[xref:#SchainsInternal-SCHAIN_TYPE_MANAGER_ROLE-bytes32[`++SCHAIN_TYPE_MANAGER_ROLE++`]]
:DEBUGGER_ROLE: pass:normal[xref:#SchainsInternal-DEBUGGER_ROLE-bytes32[`++DEBUGGER_ROLE++`]]
...
:addSchainType: pass:normal[xref:#SchainsInternal-addSchainType-uint8-uint256-[`++addSchainType++`]]
:removeSchainType: pass:normal[xref:#SchainsInternal-removeSchainType-uint256-[`++removeSchainType++`]]
:setNumberOfSchainTypes: pass:normal[xref:#SchainsInternal-setNumberOfSchainTypes-uint256-[`++setNumberOfSchainTypes++`]]
:moveToPlaceOfSchainOnNode: pass:normal[xref:#SchainsInternal-moveToPlaceOfSchainOnNode-bytes32-[`++moveToPlaceOfSchainOnNode++`]]
:removeNodeFromAllExceptionSchains: pass:normal[xref:#SchainsInternal-removeNodeFromAllExceptionSchains-uint256-[`++removeNodeFromAllExceptionSchains++`]]
:makeSchainNodesInvisible: pass:normal[xref:#SchainsInternal-makeSchainNodesInvisible-bytes32-[`++makeSchainNodesInvisible++`]]
:makeSchainNodesVisible: pass:normal[xref:#SchainsInternal-makeSchainNodesVisible-bytes32-[`++makeSchainNodesVisible++`]]
...
:getSchainHashesByAddress: pass:normal[xref:#SchainsInternal-getSchainHashesByAddress-address-[`++getSchainHashesByAddress++`]]
:getSchainIdsByAddress: pass:normal[xref:#SchainsInternal-getSchainIdsByAddress-address-[`++getSchainIdsByAddress++`]]
:getSchainHashesForNode: pass:normal[xref:#SchainsInternal-getSchainHashesForNode-uint256-[`++getSchainHashesForNode++`]]
...
:isNodeAddressesInGroup: pass:normal[xref:#SchainsInternal-isNodeAddressesInGroup-bytes32-address-[`++isNodeAddressesInGroup++`]]
...
:getSchainType: pass:normal[xref:#SchainsInternal-getSchainType-uint256-[`++getSchainType++`]]
...
:_getNodeToLockedSchains: pass:normal[xref:#SchainsInternal-_getNodeToLockedSchains--[`++_getNodeToLockedSchains++`]]
:_getSchainToExceptionNodes: pass:normal[xref:#SchainsInternal-_getSchainToExceptionNodes--[`++_getSchainToExceptionNodes++`]]
:Schain: pass:normal[xref:#SchainsInternal-Schain[`++Schain++`]]
:SchainType: pass:normal[xref:#SchainsInternal-SchainType[`++SchainType++`]]
...
.Modifiers
--
* {xref-SchainsInternal-onlySchainTypeManager--}[`++onlySchainTypeManager()++`]
* {xref-SchainsInternal-onlyDebugger--}[`++onlyDebugger()++`]
--
...
* {xref-SchainsInternal-createGroupForSchain-bytes32-uint256-uint8-}[`++createGroupForSchain(schainHash, numberOfNodes, partOfNode)++`]
* {xref-SchainsInternal-setSchainIndex-bytes32-address-}[`++setSchainIndex(schainHash, from)++`]
* {xref-SchainsInternal-changeLifetime-bytes32-uint256-uint256-}[`++changeLifetime(schainHash, lifetime, deposit)++`]
* {xref-SchainsInternal-removeSchain-bytes32-address-}[`++removeSchain(schainHash, from)++`]
* {xref-SchainsInternal-removeNodeFromSchain-uint256-bytes32-}[`++removeNodeFromSchain(nodeIndex, schainHash)++`]
* {xref-SchainsInternal-deleteGroup-bytes32-}[`++deleteGroup(schainHash)++`]
* {xref-SchainsInternal-setException-bytes32-uint256-}[`++setException(schainHash, nodeIndex)++`]
* {xref-SchainsInternal-setNodeInGroup-bytes32-uint256-}[`++setNodeInGroup(schainHash, nodeIndex)++`]
* {xref-SchainsInternal-removeHolesForSchain-bytes32-}[`++removeHolesForSchain(schainHash)++`]
* {xref-SchainsInternal-addSchainType-uint8-uint256-}[`++addSchainType(partOfNode, numberOfNodes)++`]
* {xref-SchainsInternal-removeSchainType-uint256-}[`++removeSchainType(typeOfSchain)++`]
* {xref-SchainsInternal-setNumberOfSchainTypes-uint256-}[`++setNumberOfSchainTypes(newNumberOfSchainTypes)++`]
* {xref-SchainsInternal-moveToPlaceOfSchainOnNode-bytes32-}[`++moveToPlaceOfSchainOnNode(schainHash)++`]
* {xref-SchainsInternal-removeNodeFromAllExceptionSchains-uint256-}[`++removeNodeFromAllExceptionSchains(nodeIndex)++`]
* {xref-SchainsInternal-makeSchainNodesInvisible-bytes32-}[`++makeSchainNodesInvisible(schainHash)++`]
* {xref-SchainsInternal-makeSchainNodesVisible-bytes32-}[`++makeSchainNodesVisible(schainHash)++`]
* {xref-SchainsInternal-getSchains--}[`++getSchains()++`]
* {xref-SchainsInternal-getSchainsPartOfNode-bytes32-}[`++getSchainsPartOfNode(schainHash)++`]
* {xref-SchainsInternal-getSchainListSize-address-}[`++getSchainListSize(from)++`]
* {xref-SchainsInternal-getSchainHashesByAddress-address-}[`++getSchainHashesByAddress(from)++`]
* {xref-SchainsInternal-getSchainIdsByAddress-address-}[`++getSchainIdsByAddress(from)++`]
* {xref-SchainsInternal-getSchainHashesForNode-uint256-}[`++getSchainHashesForNode(nodeIndex)++`]
* {xref-SchainsInternal-getSchainIdsForNode-uint256-}[`++getSchainIdsForNode(nodeIndex)++`]
* {xref-SchainsInternal-getSchainOwner-bytes32-}[`++getSchainOwner(schainHash)++`]
* {xref-SchainsInternal-isSchainNameAvailable-string-}[`++isSchainNameAvailable(name)++`]
* {xref-SchainsInternal-isTimeExpired-bytes32-}[`++isTimeExpired(schainHash)++`]
* {xref-SchainsInternal-isOwnerAddress-address-bytes32-}[`++isOwnerAddress(from, schainHash)++`]
* {xref-SchainsInternal-isSchainExist-bytes32-}[`++isSchainExist(schainHash)++`]
* {xref-SchainsInternal-getSchainName-bytes32-}[`++getSchainName(schainHash)++`]
...
* {xref-SchainsInternal-getNumberOfNodesInGroup-bytes32-}[`++getNumberOfNodesInGroup(schainHash)++`]
* {xref-SchainsInternal-getNodesInGroup-bytes32-}[`++getNodesInGroup(schainHash)++`]
* {xref-SchainsInternal-isNodeAddressesInGroup-bytes32-address-}[`++isNodeAddressesInGroup(schainHash, sender)++`]
* {xref-SchainsInternal-getNodeIndexInGroup-bytes32-uint256-}[`++getNodeIndexInGroup(schainHash, nodeId)++`]
* {xref-SchainsInternal-isAnyFreeNode-bytes32-}[`++isAnyFreeNode(schainHash)++`]
* {xref-SchainsInternal-checkException-bytes32-uint256-}[`++checkException(schainHash, nodeIndex)++`]
...
* {xref-SchainsInternal-getSchainType-uint256-}[`++getSchainType(typeOfSchain)++`]
* {xref-SchainsInternal-initialize-address-}[`++initialize(newContractsAddress)++`]
* {xref-SchainsInternal-addSchainForNode-uint256-bytes32-}[`++addSchainForNode(nodeIndex, schainHash)++`]
...
* {xref-SchainsInternal-findSchainAtSchainsForNode-uint256-bytes32-}[`++findSchainAtSchainsForNode(nodeIndex, schainHash)++`]
* {xref-SchainsInternal-_getNodeToLockedSchains--}[`++_getNodeToLockedSchains()++`]
* {xref-SchainsInternal-_getSchainToExceptionNodes--}[`++_getSchainToExceptionNodes()++`]
--
...
[.contract-item]
[[SchainsInternal-onlySchainTypeManager--]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-onlySchainTypeManager-->onlySchainTypeManager</a>+++ `++onlySchainTypeManager()++` [.item-kind]#modifier#



[.contract-item]
[[SchainsInternal-onlyDebugger--]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-onlyDebugger-->onlyDebugger</a>+++ `++onlyDebugger()++` [.item-kind]#modifier#
...
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-createGroupForSchain-bytes32-uint256-uint8->createGroupForSchain</a>+++ `++createGroupForSchain(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++numberOfNodes++#++, ++[.var-type]#++uint8++#++ ++[.var-name]#++partOfNode++#++) → ++[.var-type]#++uint256[]++#++++` [.item-kind]#external#

Allows Schain contract to create a node group for an schain.

[.contract-item]
[[SchainsInternal-setSchainIndex-bytes32-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-setSchainIndex-bytes32-address->setSchainIndex</a>+++ `++setSchainIndex(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++from++#++)++` [.item-kind]#external#

Allows Schains contract to set index in owner list.

[.contract-item]
[[SchainsInternal-changeLifetime-bytes32-uint256-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-changeLifetime-bytes32-uint256-uint256->changeLifetime</a>+++ `++changeLifetime(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++lifetime++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++deposit++#++)++` [.item-kind]#external#
...
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-removeSchain-bytes32-address->removeSchain</a>+++ `++removeSchain(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++from++#++)++` [.item-kind]#external#
...
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-deleteGroup-bytes32->deleteGroup</a>+++ `++deleteGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#external#

Allows Schains contract to delete a group of schains

[.contract-item]
[[SchainsInternal-setException-bytes32-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-setException-bytes32-uint256->setException</a>+++ `++setException(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#

Allows Schain and NodeRotation contracts to set a Node like
exception for a given schain and nodeIndex.

[.contract-item]
[[SchainsInternal-setNodeInGroup-bytes32-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-setNodeInGroup-bytes32-uint256->setNodeInGroup</a>+++ `++setNodeInGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#

Allows Schains and NodeRotation contracts to add node to an schain
group.
...
[.contract-item]
[[SchainsInternal-addSchainType-uint8-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-addSchainType-uint8-uint256->addSchainType</a>+++ `++addSchainType(++[.var-type]#++uint8++#++ ++[.var-name]#++partOfNode++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++numberOfNodes++#++)++` [.item-kind]#external#

Allows Admin to add schain type

[.contract-item]
[[SchainsInternal-removeSchainType-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-removeSchainType-uint256->removeSchainType</a>+++ `++removeSchainType(++[.var-type]#++uint256++#++ ++[.var-name]#++typeOfSchain++#++)++` [.item-kind]#external#

Allows Admin to remove schain type

[.contract-item]
[[SchainsInternal-setNumberOfSchainTypes-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-setNumberOfSchainTypes-uint256->setNumberOfSchainTypes</a>+++ `++setNumberOfSchainTypes(++[.var-type]#++uint256++#++ ++[.var-name]#++newNumberOfSchainTypes++#++)++` [.item-kind]#external#

Allows Admin to set number of schain types

[.contract-item]
[[SchainsInternal-moveToPlaceOfSchainOnNode-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-moveToPlaceOfSchainOnNode-bytes32->moveToPlaceOfSchainOnNode</a>+++ `++moveToPlaceOfSchainOnNode(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#external#

Allows Admin to move schain to placeOfSchainOnNode map

[.contract-item]
[[SchainsInternal-removeNodeFromAllExceptionSchains-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-removeNodeFromAllExceptionSchains-uint256->removeNodeFromAllExceptionSchains</a>+++ `++removeNodeFromAllExceptionSchains(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#



[.contract-item]
[[SchainsInternal-makeSchainNodesInvisible-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-makeSchainNodesInvisible-bytes32->makeSchainNodesInvisible</a>+++ `++makeSchainNodesInvisible(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#external#



[.contract-item]
[[SchainsInternal-makeSchainNodesVisible-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-makeSchainNodesVisible-bytes32->makeSchainNodesVisible</a>+++ `++makeSchainNodesVisible(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#external#
...
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getSchainsPartOfNode-bytes32->getSchainsPartOfNode</a>+++ `++getSchainsPartOfNode(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++uint8++#++++` [.item-kind]#external#
...
[.contract-item]
[[SchainsInternal-getSchainHashesByAddress-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getSchainHashesByAddress-address->getSchainHashesByAddress</a>+++ `++getSchainHashesByAddress(++[.var-type]#++address++#++ ++[.var-name]#++from++#++) → ++[.var-type]#++bytes32[]++#++++` [.item-kind]#external#
...
[.contract-item]
[[SchainsInternal-getSchainHashesForNode-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getSchainHashesForNode-uint256->getSchainHashesForNode</a>+++ `++getSchainHashesForNode(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bytes32[]++#++++` [.item-kind]#external#
...
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getSchainOwner-bytes32->getSchainOwner</a>+++ `++getSchainOwner(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++address++#++++` [.item-kind]#external#
...
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-isTimeExpired-bytes32->isTimeExpired</a>+++ `++isTimeExpired(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether schain lifetime has expired.

[.contract-item]
[[SchainsInternal-isOwnerAddress-address-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-isOwnerAddress-address-bytes32->isOwnerAddress</a>+++ `++isOwnerAddress(++[.var-type]#++address++#++ ++[.var-name]#++from++#++, ++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether address is owner of schain.

[.contract-item]
[[SchainsInternal-isSchainExist-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-isSchainExist-bytes32->isSchainExist</a>+++ `++isSchainExist(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether schain exists.

[.contract-item]
[[SchainsInternal-getSchainName-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getSchainName-bytes32->getSchainName</a>+++ `++getSchainName(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++string++#++++` [.item-kind]#external#
...
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getNumberOfNodesInGroup-bytes32->getNumberOfNodesInGroup</a>+++ `++getNumberOfNodesInGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Returns number of nodes in an schain group.

[.contract-item]
[[SchainsInternal-getNodesInGroup-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getNodesInGroup-bytes32->getNodesInGroup</a>+++ `++getNodesInGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++uint256[]++#++++` [.item-kind]#external#

Returns nodes in an schain group.

[.contract-item]
[[SchainsInternal-isNodeAddressesInGroup-bytes32-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-isNodeAddressesInGroup-bytes32-address->isNodeAddressesInGroup</a>+++ `++isNodeAddressesInGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++address++#++ ++[.var-name]#++sender++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether sender is a node address from a given schain group.

[.contract-item]
[[SchainsInternal-getNodeIndexInGroup-bytes32-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getNodeIndexInGroup-bytes32-uint256->getNodeIndexInGroup</a>+++ `++getNodeIndexInGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeId++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Returns node index in schain group.

[.contract-item]
[[SchainsInternal-isAnyFreeNode-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-isAnyFreeNode-bytes32->isAnyFreeNode</a>+++ `++isAnyFreeNode(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether there are any nodes with free resources for given
schain.

[.contract-item]
[[SchainsInternal-checkException-bytes32-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-checkException-bytes32-uint256->checkException</a>+++ `++checkException(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#
...
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getLengthOfSchainsForNode-uint256->getLengthOfSchainsForNode</a>+++ `++getLengthOfSchainsForNode(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Returns number of Schains on a node.

[.contract-item]
[[SchainsInternal-getSchainType-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getSchainType-uint256->getSchainType</a>+++ `++getSchainType(++[.var-type]#++uint256++#++ ++[.var-name]#++typeOfSchain++#++) → ++[.var-type]#++uint8++#++, ++[.var-type]#++uint256++#++++` [.item-kind]#external#
...
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-addSchainForNode-uint256-bytes32->addSchainForNode</a>+++ `++addSchainForNode(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#public#
...
Allows Schains, NodeRotation, and SkaleDKG contracts to remove an 
schain from a node.

[.contract-item]
[[SchainsInternal-removeNodeFromExceptions-bytes32-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-removeNodeFromExceptions-bytes32-uint256->removeNodeFromExceptions</a>+++ `++removeNodeFromExceptions(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#public#

Allows Schains contract to remove node from exceptions

[.contract-item]
[[SchainsInternal-findSchainAtSchainsForNode-uint256-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-findSchainAtSchainsForNode-uint256-bytes32->findSchainAtSchainsForNode</a>+++ `++findSchainAtSchainsForNode(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#public#

Returns index of Schain in list of schains for a given node.

[.contract-item]
[[SchainsInternal-_getNodeToLockedSchains--]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-_getNodeToLockedSchains-->_getNodeToLockedSchains</a>+++ `++_getNodeToLockedSchains() → ++[.var-type]#++mapping(uint256 => bytes32[])++#++++` [.item-kind]#internal#



[.contract-item]
[[SchainsInternal-_getSchainToExceptionNodes--]]
== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-_getSchainToExceptionNodes-->_getSchainToExceptionNodes</a>+++ `++_getSchainToExceptionNodes() → ++[.var-type]#++mapping(bytes32 => uint256[])++#++++` [.item-kind]#internal#
