...
:correctNodeWithoutRevert: pass:normal[xref:#SkaleDKG-correctNodeWithoutRevert-bytes32-uint256-[`++correctNodeWithoutRevert++`]]
:onlyNodeOwner: pass:normal[xref:#SkaleDKG-onlyNodeOwner-uint256-[`++onlyNodeOwner++`]]
:refundGasBySchain: pass:normal[xref:#SkaleDKG-refundGasBySchain-bytes32-struct-SkaleDKG-Context-[`++refundGasBySchain++`]]
:refundGasByValidatorToSchain: pass:normal[xref:#SkaleDKG-refundGasByValidatorToSchain-bytes32-struct-SkaleDKG-Context-[`++refundGasByValidatorToSchain++`]]
:channels: pass:normal[xref:#SkaleDKG-channels-mapping-bytes32----struct-SkaleDKG-Channel-[`++channels++`]]
:lastSuccessfulDKG: pass:normal[xref:#SkaleDKG-lastSuccessfulDKG-mapping-bytes32----uint256-[`++lastSuccessfulDKG++`]]
...
:complaintBadData: pass:normal[xref:#SkaleDKG-complaintBadData-bytes32-uint256-uint256-[`++complaintBadData++`]]
:preResponse: pass:normal[xref:#SkaleDKG-preResponse-bytes32-uint256-struct-G2Operations-G2Point---struct-G2Operations-G2Point---struct-SkaleDKG-KeyShare---[`++preResponse++`]]
...
:setStartAlrightTimestamp: pass:normal[xref:#SkaleDKG-setStartAlrightTimestamp-bytes32-[`++setStartAlrightTimestamp++`]]
:setBadNode: pass:normal[xref:#SkaleDKG-setBadNode-bytes32-uint256-[`++setBadNode++`]]
:finalizeSlashing: pass:normal[xref:#SkaleDKG-finalizeSlashing-bytes32-uint256-[`++finalizeSlashing++`]]
...
:getTimeOfLastSuccessfulDKG: pass:normal[xref:#SkaleDKG-getTimeOfLastSuccessfulDKG-bytes32-[`++getTimeOfLastSuccessfulDKG++`]]
...
:isPreResponsePossible: pass:normal[xref:#SkaleDKG-isPreResponsePossible-bytes32-uint256-[`++isPreResponsePossible++`]]
...
:hashData: pass:normal[xref:#SkaleDKG-hashData-struct-SkaleDKG-KeyShare---struct-G2Operations-G2Point---[`++hashData++`]]
:initialize: pass:normal[xref:#SkaleDKG-initialize-address-[`++initialize++`]]
:checkAndReturnIndexInGroup: pass:normal[xref:#SkaleDKG-checkAndReturnIndexInGroup-bytes32-uint256-bool-[`++checkAndReturnIndexInGroup++`]]
...
:Channel: pass:normal[xref:#SkaleDKG-Channel[`++Channel++`]]
:ProcessDKG: pass:normal[xref:#SkaleDKG-ProcessDKG[`++ProcessDKG++`]]
:ComplaintData: pass:normal[xref:#SkaleDKG-ComplaintData[`++ComplaintData++`]]
:KeyShare: pass:normal[xref:#SkaleDKG-KeyShare[`++KeyShare++`]]
:Context: pass:normal[xref:#SkaleDKG-Context[`++Context++`]]
:DkgFunction: pass:normal[xref:#SkaleDKG-DkgFunction[`++DkgFunction++`]]
...
.Modifiers
--
* {xref-SkaleDKG-correctGroup-bytes32-}[`++correctGroup(schainHash)++`]
* {xref-SkaleDKG-correctGroupWithoutRevert-bytes32-}[`++correctGroupWithoutRevert(schainHash)++`]
* {xref-SkaleDKG-correctNode-bytes32-uint256-}[`++correctNode(schainHash, nodeIndex)++`]
* {xref-SkaleDKG-correctNodeWithoutRevert-bytes32-uint256-}[`++correctNodeWithoutRevert(schainHash, nodeIndex)++`]
* {xref-SkaleDKG-onlyNodeOwner-uint256-}[`++onlyNodeOwner(nodeIndex)++`]
* {xref-SkaleDKG-refundGasBySchain-bytes32-struct-SkaleDKG-Context-}[`++refundGasBySchain(schainHash, context)++`]
* {xref-SkaleDKG-refundGasByValidatorToSchain-bytes32-struct-SkaleDKG-Context-}[`++refundGasByValidatorToSchain(schainHash, context)++`]
--

[.contract-index]
.Functions
--
* {xref-SkaleDKG-alright-bytes32-uint256-}[`++alright(schainHash, fromNodeIndex)++`]
* {xref-SkaleDKG-broadcast-bytes32-uint256-struct-G2Operations-G2Point---struct-SkaleDKG-KeyShare---}[`++broadcast(schainHash, nodeIndex, verificationVector, secretKeyContribution)++`]
* {xref-SkaleDKG-complaintBadData-bytes32-uint256-uint256-}[`++complaintBadData(schainHash, fromNodeIndex, toNodeIndex)++`]
* {xref-SkaleDKG-preResponse-bytes32-uint256-struct-G2Operations-G2Point---struct-G2Operations-G2Point---struct-SkaleDKG-KeyShare---}[`++preResponse(schainId, fromNodeIndex, verificationVector, verificationVectorMultiplication, secretKeyContribution)++`]
* {xref-SkaleDKG-complaint-bytes32-uint256-uint256-}[`++complaint(schainHash, fromNodeIndex, toNodeIndex)++`]
* {xref-SkaleDKG-response-bytes32-uint256-uint256-struct-G2Operations-G2Point-}[`++response(schainHash, fromNodeIndex, secretNumber, multipliedShare)++`]
* {xref-SkaleDKG-openChannel-bytes32-}[`++openChannel(schainHash)++`]
* {xref-SkaleDKG-deleteChannel-bytes32-}[`++deleteChannel(schainHash)++`]
* {xref-SkaleDKG-setStartAlrightTimestamp-bytes32-}[`++setStartAlrightTimestamp(schainHash)++`]
* {xref-SkaleDKG-setBadNode-bytes32-uint256-}[`++setBadNode(schainHash, nodeIndex)++`]
* {xref-SkaleDKG-finalizeSlashing-bytes32-uint256-}[`++finalizeSlashing(schainHash, badNode)++`]
* {xref-SkaleDKG-getChannelStartedTime-bytes32-}[`++getChannelStartedTime(schainHash)++`]
* {xref-SkaleDKG-getChannelStartedBlock-bytes32-}[`++getChannelStartedBlock(schainHash)++`]
* {xref-SkaleDKG-getNumberOfBroadcasted-bytes32-}[`++getNumberOfBroadcasted(schainHash)++`]
* {xref-SkaleDKG-getNumberOfCompleted-bytes32-}[`++getNumberOfCompleted(schainHash)++`]
* {xref-SkaleDKG-getTimeOfLastSuccessfulDKG-bytes32-}[`++getTimeOfLastSuccessfulDKG(schainHash)++`]
* {xref-SkaleDKG-getComplaintData-bytes32-}[`++getComplaintData(schainHash)++`]
* {xref-SkaleDKG-getComplaintStartedTime-bytes32-}[`++getComplaintStartedTime(schainHash)++`]
* {xref-SkaleDKG-getAlrightStartedTime-bytes32-}[`++getAlrightStartedTime(schainHash)++`]
* {xref-SkaleDKG-isChannelOpened-bytes32-}[`++isChannelOpened(schainHash)++`]
* {xref-SkaleDKG-isLastDKGSuccessful-bytes32-}[`++isLastDKGSuccessful(schainHash)++`]
* {xref-SkaleDKG-isBroadcastPossible-bytes32-uint256-}[`++isBroadcastPossible(schainHash, nodeIndex)++`]
* {xref-SkaleDKG-isComplaintPossible-bytes32-uint256-uint256-}[`++isComplaintPossible(schainHash, fromNodeIndex, toNodeIndex)++`]
* {xref-SkaleDKG-isAlrightPossible-bytes32-uint256-}[`++isAlrightPossible(schainHash, nodeIndex)++`]
* {xref-SkaleDKG-isPreResponsePossible-bytes32-uint256-}[`++isPreResponsePossible(schainHash, nodeIndex)++`]
* {xref-SkaleDKG-isResponsePossible-bytes32-uint256-}[`++isResponsePossible(schainHash, nodeIndex)++`]
* {xref-SkaleDKG-isNodeBroadcasted-bytes32-uint256-}[`++isNodeBroadcasted(schainHash, nodeIndex)++`]
* {xref-SkaleDKG-isAllDataReceived-bytes32-uint256-}[`++isAllDataReceived(schainHash, nodeIndex)++`]
* {xref-SkaleDKG-hashData-struct-SkaleDKG-KeyShare---struct-G2Operations-G2Point---}[`++hashData(secretKeyContribution, verificationVector)++`]
* {xref-SkaleDKG-initialize-address-}[`++initialize(contractsAddress)++`]
* {xref-SkaleDKG-checkAndReturnIndexInGroup-bytes32-uint256-bool-}[`++checkAndReturnIndexInGroup(schainHash, nodeIndex, revertCheck)++`]
* {xref-SkaleDKG-isEveryoneBroadcasted-bytes32-}[`++isEveryoneBroadcasted(schainHash)++`]
--

[.contract-index]
.Events
--
* {xref-SkaleDKG-ChannelOpened-bytes32-}[`++ChannelOpened(schainHash)++`]
* {xref-SkaleDKG-ChannelClosed-bytes32-}[`++ChannelClosed(schainHash)++`]
* {xref-SkaleDKG-BroadcastAndKeyShare-bytes32-uint256-struct-G2Operations-G2Point---struct-SkaleDKG-KeyShare---}[`++BroadcastAndKeyShare(schainHash, fromNode, verificationVector, secretKeyContribution)++`]
* {xref-SkaleDKG-AllDataReceived-bytes32-uint256-}[`++AllDataReceived(schainHash, nodeIndex)++`]
* {xref-SkaleDKG-SuccessfulDKG-bytes32-}[`++SuccessfulDKG(schainHash)++`]
* {xref-SkaleDKG-BadGuy-uint256-}[`++BadGuy(nodeIndex)++`]
* {xref-SkaleDKG-FailedDKG-bytes32-}[`++FailedDKG(schainHash)++`]
* {xref-SkaleDKG-NewGuy-uint256-}[`++NewGuy(nodeIndex)++`]
* {xref-SkaleDKG-ComplaintError-string-}[`++ComplaintError(error)++`]
* {xref-SkaleDKG-ComplaintSent-bytes32-uint256-uint256-}[`++ComplaintSent(schainHash, fromNodeIndex, toNodeIndex)++`]
--

[.contract-item]
[[SkaleDKG-correctGroup-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-correctGroup-bytes32->correctGroup</a>+++ `++correctGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#modifier#



[.contract-item]
[[SkaleDKG-correctGroupWithoutRevert-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-correctGroupWithoutRevert-bytes32->correctGroupWithoutRevert</a>+++ `++correctGroupWithoutRevert(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#modifier#



[.contract-item]
[[SkaleDKG-correctNode-bytes32-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-correctNode-bytes32-uint256->correctNode</a>+++ `++correctNode(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#modifier#



[.contract-item]
[[SkaleDKG-correctNodeWithoutRevert-bytes32-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-correctNodeWithoutRevert-bytes32-uint256->correctNodeWithoutRevert</a>+++ `++correctNodeWithoutRevert(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#modifier#



[.contract-item]
[[SkaleDKG-onlyNodeOwner-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-onlyNodeOwner-uint256->onlyNodeOwner</a>+++ `++onlyNodeOwner(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#modifier#



[.contract-item]
[[SkaleDKG-refundGasBySchain-bytes32-struct-SkaleDKG-Context-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-refundGasBySchain-bytes32-struct-SkaleDKG-Context->refundGasBySchain</a>+++ `++refundGasBySchain(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++struct SkaleDKG.Context++#++ ++[.var-name]#++context++#++)++` [.item-kind]#modifier#



[.contract-item]
[[SkaleDKG-refundGasByValidatorToSchain-bytes32-struct-SkaleDKG-Context-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-refundGasByValidatorToSchain-bytes32-struct-SkaleDKG-Context->refundGasByValidatorToSchain</a>+++ `++refundGasByValidatorToSchain(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++struct SkaleDKG.Context++#++ ++[.var-name]#++context++#++)++` [.item-kind]#modifier#
...
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-alright-bytes32-uint256->alright</a>+++ `++alright(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++fromNodeIndex++#++)++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-broadcast-bytes32-uint256-struct-G2Operations-G2Point---struct-SkaleDKG-KeyShare---]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-broadcast-bytes32-uint256-struct-G2Operations-G2Point---struct-SkaleDKG-KeyShare--->broadcast</a>+++ `++broadcast(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++struct G2Operations.G2Point[]++#++ ++[.var-name]#++verificationVector++#++, ++[.var-type]#++struct SkaleDKG.KeyShare[]++#++ ++[.var-name]#++secretKeyContribution++#++)++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-complaintBadData-bytes32-uint256-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-complaintBadData-bytes32-uint256-uint256->complaintBadData</a>+++ `++complaintBadData(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++fromNodeIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++toNodeIndex++#++)++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-preResponse-bytes32-uint256-struct-G2Operations-G2Point---struct-G2Operations-G2Point---struct-SkaleDKG-KeyShare---]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-preResponse-bytes32-uint256-struct-G2Operations-G2Point---struct-G2Operations-G2Point---struct-SkaleDKG-KeyShare--->preResponse</a>+++ `++preResponse(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++fromNodeIndex++#++, ++[.var-type]#++struct G2Operations.G2Point[]++#++ ++[.var-name]#++verificationVector++#++, ++[.var-type]#++struct G2Operations.G2Point[]++#++ ++[.var-name]#++verificationVectorMultiplication++#++, ++[.var-type]#++struct SkaleDKG.KeyShare[]++#++ ++[.var-name]#++secretKeyContribution++#++)++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-complaint-bytes32-uint256-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-complaint-bytes32-uint256-uint256->complaint</a>+++ `++complaint(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++fromNodeIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++toNodeIndex++#++)++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-response-bytes32-uint256-uint256-struct-G2Operations-G2Point-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-response-bytes32-uint256-uint256-struct-G2Operations-G2Point->response</a>+++ `++response(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++fromNodeIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++secretNumber++#++, ++[.var-type]#++struct G2Operations.G2Point++#++ ++[.var-name]#++multipliedShare++#++)++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-openChannel-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-openChannel-bytes32->openChannel</a>+++ `++openChannel(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#external#
...
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-deleteChannel-bytes32->deleteChannel</a>+++ `++deleteChannel(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#external#
...
[.contract-item]
[[SkaleDKG-setStartAlrightTimestamp-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-setStartAlrightTimestamp-bytes32->setStartAlrightTimestamp</a>+++ `++setStartAlrightTimestamp(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-setBadNode-bytes32-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-setBadNode-bytes32-uint256->setBadNode</a>+++ `++setBadNode(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-finalizeSlashing-bytes32-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-finalizeSlashing-bytes32-uint256->finalizeSlashing</a>+++ `++finalizeSlashing(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++badNode++#++)++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-getChannelStartedTime-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-getChannelStartedTime-bytes32->getChannelStartedTime</a>+++ `++getChannelStartedTime(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-getChannelStartedBlock-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-getChannelStartedBlock-bytes32->getChannelStartedBlock</a>+++ `++getChannelStartedBlock(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-getNumberOfBroadcasted-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-getNumberOfBroadcasted-bytes32->getNumberOfBroadcasted</a>+++ `++getNumberOfBroadcasted(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-getNumberOfCompleted-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-getNumberOfCompleted-bytes32->getNumberOfCompleted</a>+++ `++getNumberOfCompleted(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-getTimeOfLastSuccessfulDKG-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-getTimeOfLastSuccessfulDKG-bytes32->getTimeOfLastSuccessfulDKG</a>+++ `++getTimeOfLastSuccessfulDKG(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-getComplaintData-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-getComplaintData-bytes32->getComplaintData</a>+++ `++getComplaintData(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++uint256++#++, ++[.var-type]#++uint256++#++++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-getComplaintStartedTime-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-getComplaintStartedTime-bytes32->getComplaintStartedTime</a>+++ `++getComplaintStartedTime(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-getAlrightStartedTime-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-getAlrightStartedTime-bytes32->getAlrightStartedTime</a>+++ `++getAlrightStartedTime(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-isChannelOpened-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-isChannelOpened-bytes32->isChannelOpened</a>+++ `++isChannelOpened(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether channel is opened.

[.contract-item]
[[SkaleDKG-isLastDKGSuccessful-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-isLastDKGSuccessful-bytes32->isLastDKGSuccessful</a>+++ `++isLastDKGSuccessful(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-isBroadcastPossible-bytes32-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-isBroadcastPossible-bytes32-uint256->isBroadcastPossible</a>+++ `++isBroadcastPossible(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether broadcast is possible.

[.contract-item]
[[SkaleDKG-isComplaintPossible-bytes32-uint256-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-isComplaintPossible-bytes32-uint256-uint256->isComplaintPossible</a>+++ `++isComplaintPossible(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++fromNodeIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++toNodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether complaint is possible.

[.contract-item]
[[SkaleDKG-isAlrightPossible-bytes32-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-isAlrightPossible-bytes32-uint256->isAlrightPossible</a>+++ `++isAlrightPossible(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether sending Alright response is possible.

[.contract-item]
[[SkaleDKG-isPreResponsePossible-bytes32-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-isPreResponsePossible-bytes32-uint256->isPreResponsePossible</a>+++ `++isPreResponsePossible(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether sending a pre-response is possible.

[.contract-item]
[[SkaleDKG-isResponsePossible-bytes32-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-isResponsePossible-bytes32-uint256->isResponsePossible</a>+++ `++isResponsePossible(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether sending a response is possible.

[.contract-item]
[[SkaleDKG-isNodeBroadcasted-bytes32-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-isNodeBroadcasted-bytes32-uint256->isNodeBroadcasted</a>+++ `++isNodeBroadcasted(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#



[.contract-item]
[[SkaleDKG-isAllDataReceived-bytes32-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-isAllDataReceived-bytes32-uint256->isAllDataReceived</a>+++ `++isAllDataReceived(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether all data has been received by node.

[.contract-item]
[[SkaleDKG-hashData-struct-SkaleDKG-KeyShare---struct-G2Operations-G2Point---]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-hashData-struct-SkaleDKG-KeyShare---struct-G2Operations-G2Point--->hashData</a>+++ `++hashData(++[.var-type]#++struct SkaleDKG.KeyShare[]++#++ ++[.var-name]#++secretKeyContribution++#++, ++[.var-type]#++struct G2Operations.G2Point[]++#++ ++[.var-name]#++verificationVector++#++) → ++[.var-type]#++bytes32++#++++` [.item-kind]#external#
...
[.contract-item]
[[SkaleDKG-checkAndReturnIndexInGroup-bytes32-uint256-bool-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-checkAndReturnIndexInGroup-bytes32-uint256-bool->checkAndReturnIndexInGroup</a>+++ `++checkAndReturnIndexInGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++bool++#++ ++[.var-name]#++revertCheck++#++) → ++[.var-type]#++uint256++#++, ++[.var-type]#++bool++#++++` [.item-kind]#public#



[.contract-item]
[[SkaleDKG-isEveryoneBroadcasted-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-isEveryoneBroadcasted-bytes32->isEveryoneBroadcasted</a>+++ `++isEveryoneBroadcasted(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#public#
...
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-ChannelOpened-bytes32->ChannelOpened</a>+++ `++ChannelOpened(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#event#

Emitted when a channel is opened.

[.contract-item]
[[SkaleDKG-ChannelClosed-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-ChannelClosed-bytes32->ChannelClosed</a>+++ `++ChannelClosed(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#event#

Emitted when a channel is closed.

[.contract-item]
[[SkaleDKG-BroadcastAndKeyShare-bytes32-uint256-struct-G2Operations-G2Point---struct-SkaleDKG-KeyShare---]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-BroadcastAndKeyShare-bytes32-uint256-struct-G2Operations-G2Point---struct-SkaleDKG-KeyShare--->BroadcastAndKeyShare</a>+++ `++BroadcastAndKeyShare(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++fromNode++#++, ++[.var-type]#++struct G2Operations.G2Point[]++#++ ++[.var-name]#++verificationVector++#++, ++[.var-type]#++struct SkaleDKG.KeyShare[]++#++ ++[.var-name]#++secretKeyContribution++#++)++` [.item-kind]#event#

Emitted when a node broadcasts key share.

[.contract-item]
[[SkaleDKG-AllDataReceived-bytes32-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-AllDataReceived-bytes32-uint256->AllDataReceived</a>+++ `++AllDataReceived(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#event#

Emitted when all group data is received by node.

[.contract-item]
[[SkaleDKG-SuccessfulDKG-bytes32-]]
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-SuccessfulDKG-bytes32->SuccessfulDKG</a>+++ `++SuccessfulDKG(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#event#
...
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-FailedDKG-bytes32->FailedDKG</a>+++ `++FailedDKG(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#event#
...
== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-ComplaintSent-bytes32-uint256-uint256->ComplaintSent</a>+++ `++ComplaintSent(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++fromNodeIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++toNodeIndex++#++)++` [.item-kind]#event#
