...
:onlyValidatorManager: pass:normal[xref:#ValidatorService-onlyValidatorManager--[`++onlyValidatorManager++`]]
...
:VALIDATOR_MANAGER_ROLE: pass:normal[xref:#ValidatorService-VALIDATOR_MANAGER_ROLE-bytes32[`++VALIDATOR_MANAGER_ROLE++`]]
...
:removeNodeAddress: pass:normal[xref:#ValidatorService-removeNodeAddress-uint256-address-[`++removeNodeAddress++`]]
...
:checkValidatorCanReceiveDelegation: pass:normal[xref:#ValidatorService-checkValidatorCanReceiveDelegation-uint256-uint256-[`++checkValidatorCanReceiveDelegation++`]]
...
:Validator: pass:normal[xref:#ValidatorService-Validator[`++Validator++`]]
...
.Modifiers
--
* {xref-ValidatorService-onlyValidatorManager--}[`++onlyValidatorManager()++`]
...
* {xref-ValidatorService-removeNodeAddress-uint256-address-}[`++removeNodeAddress(validatorId, nodeAddress)++`]
...
* {xref-ValidatorService-checkValidatorCanReceiveDelegation-uint256-uint256-}[`++checkValidatorCanReceiveDelegation(validatorId, amount)++`]
...
[.contract-item]
[[ValidatorService-onlyValidatorManager--]]
== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-onlyValidatorManager-->onlyValidatorManager</a>+++ `++onlyValidatorManager()++` [.item-kind]#modifier#
...
Links a node address to validator ID. Validator must present
...
[.contract-item]
[[ValidatorService-removeNodeAddress-uint256-address-]]
== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-removeNodeAddress-uint256-address->removeNodeAddress</a>+++ `++removeNodeAddress(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++, ++[.var-type]#++address++#++ ++[.var-name]#++nodeAddress++#++)++` [.item-kind]#external#
...
[.contract-item]
[[ValidatorService-checkValidatorCanReceiveDelegation-uint256-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-checkValidatorCanReceiveDelegation-uint256-uint256->checkValidatorCanReceiveDelegation</a>+++ `++checkValidatorCanReceiveDelegation(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++amount++#++)++` [.item-kind]#external#
...
== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-isAuthorizedValidator-uint256->isAuthorizedValidator</a>+++ `++isAuthorizedValidator(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#public#
