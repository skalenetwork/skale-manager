...
:UNDELEGATION_PROHIBITION_WINDOW_SECONDS: pass:normal[xref:#DelegationController-UNDELEGATION_PROHIBITION_WINDOW_SECONDS-uint256[`++UNDELEGATION_PROHIBITION_WINDOW_SECONDS++`]]
...
:getEffectiveDelegatedValuesByValidator: pass:normal[xref:#DelegationController-getEffectiveDelegatedValuesByValidator-uint256-[`++getEffectiveDelegatedValuesByValidator++`]]
:getEffectiveDelegatedToValidator: pass:normal[xref:#DelegationController-getEffectiveDelegatedToValidator-uint256-uint256-[`++getEffectiveDelegatedToValidator++`]]
:getDelegatedToValidator: pass:normal[xref:#DelegationController-getDelegatedToValidator-uint256-uint256-[`++getDelegatedToValidator++`]]
...
:Delegation: pass:normal[xref:#DelegationController-Delegation[`++Delegation++`]]
:SlashingLogEvent: pass:normal[xref:#DelegationController-SlashingLogEvent[`++SlashingLogEvent++`]]
:SlashingLog: pass:normal[xref:#DelegationController-SlashingLog[`++SlashingLog++`]]
:DelegationExtras: pass:normal[xref:#DelegationController-DelegationExtras[`++DelegationExtras++`]]
:SlashingEvent: pass:normal[xref:#DelegationController-SlashingEvent[`++SlashingEvent++`]]
:SlashingSignal: pass:normal[xref:#DelegationController-SlashingSignal[`++SlashingSignal++`]]
:LockedInPending: pass:normal[xref:#DelegationController-LockedInPending[`++LockedInPending++`]]
:FirstDelegationMonth: pass:normal[xref:#DelegationController-FirstDelegationMonth[`++FirstDelegationMonth++`]]
:ValidatorsStatistics: pass:normal[xref:#DelegationController-ValidatorsStatistics[`++ValidatorsStatistics++`]]
:State: pass:normal[xref:#DelegationController-State[`++State++`]]
...
* {xref-DelegationController-getEffectiveDelegatedValuesByValidator-uint256-}[`++getEffectiveDelegatedValuesByValidator(validatorId)++`]
* {xref-DelegationController-getEffectiveDelegatedToValidator-uint256-uint256-}[`++getEffectiveDelegatedToValidator(validatorId, month)++`]
* {xref-DelegationController-getDelegatedToValidator-uint256-uint256-}[`++getDelegatedToValidator(validatorId, month)++`]
...
Update and return the effective amount delegated (minus slash) for
the given month.
...
Return and update the amount delegated to a validator for the
current month.

[.contract-item]
[[DelegationController-getEffectiveDelegatedValuesByValidator-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=DelegationController-getEffectiveDelegatedValuesByValidator-uint256->getEffectiveDelegatedValuesByValidator</a>+++ `++getEffectiveDelegatedValuesByValidator(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++) → ++[.var-type]#++uint256[]++#++++` [.item-kind]#external#



[.contract-item]
[[DelegationController-getEffectiveDelegatedToValidator-uint256-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=DelegationController-getEffectiveDelegatedToValidator-uint256-uint256->getEffectiveDelegatedToValidator</a>+++ `++getEffectiveDelegatedToValidator(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++month++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#



[.contract-item]
[[DelegationController-getDelegatedToValidator-uint256-uint256-]]
== +++<a class="heading-anchor" area-hidden="true" name=DelegationController-getDelegatedToValidator-uint256-uint256->getDelegatedToValidator</a>+++ `++getDelegatedToValidator(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++month++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#
